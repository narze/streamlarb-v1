<script lang="ts">
  ...
  function updateWidgetsData({id, x, y, w, h}) {
    ...
    const widgetsData = JSON.parse(localStorage.getItem(localStorageKey) || "{}")
...
<main style="width: 100%; height: 100vh;">
  <div id="widget-1" style="width: 600px; height: 600px; position: fixed; overflow: hidden;">
  ...
  <div id="widget-2" style="width: 600px; height: 600px; position: fixed; overflow: hidden;">
  ...
  <div id="widget-3" style="width: 600px; height: 600px; position: fixed; overflow: hidden;">
    <div class="draggable resizable" style="width: 100%; height: 100%; background-color: rgba(100, 0, 0, 0); z-index: 100; position: absolute;"></div>
