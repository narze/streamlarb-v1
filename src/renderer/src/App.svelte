...
<main class="w-full h-screen">
  ...
  >
    <div
      ...
      style="width: 100%; height: 100%; background-color: rgba(100, 0, 0, 0); z-index: 100; position: absolute;"
    />
    {#if editMode}
      <div
        style="background-color: rgba(0, 100, 0, 1); width: 100%; height: 100%; z-index: -1; position: absolute;"
      />
    {/if}
    <iframe
      title="frame_1"
  ...
  >
    <div
      class="draggable resizable"
      style="width: 100%; height: 100%; background-color: rgba(100, 0, 0, 0); z-index: 100; position: fixed;"
    />
    {#if editMode}
      <div
        style="background-color: rgba(0, 100, 0, 1); width: 100%; height: 100%; z-index: -1; position: absolute;"
